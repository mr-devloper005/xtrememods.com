export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'xtrememods',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Xtrememods',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'xtrememods.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://xtrememods.com',
